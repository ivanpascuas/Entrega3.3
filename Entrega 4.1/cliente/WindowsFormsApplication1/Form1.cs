...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (palindromo_but.Checked)
            {
        ...
        private void fahrenheit_but_Click(object sender, EventArgs e)
        {
            string mensaje = "5/" + Celsius_box.Text;
            // Enviamos al servidor el nombre tecleado
            byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
            server.Send(msg);
            ...
            MessageBox.Show("Esto son " + mensaje + " ºF.");
        }

        private void celsius_but_Click(object sender, EventArgs e)
        {
            string mensaje = "6/" + Fahrenheit_box.Text;
            // Enviamos al servidor el nombre tecleado
            byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
            server.Send(msg);
            ...
            MessageBox.Show("Esto son " + mensaje + " ºC.");
        }
    }
}
